...
**Default path for this account:** Rebuild Search into the **13 campaigns + Brand** in `01-campaign-structure.md` (including Fly Patient Home and Emergency Patient Return), keep any proven Exact keywords that convert, discard Broad Match until conversion volume is stable.
...
### Days 3–5 — Structure
1. Create 13 Search campaigns + Brand (paused).
