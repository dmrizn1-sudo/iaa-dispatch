...
## 1. Campaign list (11 Search campaigns)
...
Start with: New York, Miami, London, Paris, Berlin, Zurich, Rome, Athens, Heraklion, Rhodes, Santorini, Larnaca, Dubai, Bangkok, Toronto, Los Angeles, Boston, Barcelona, Amsterdam, Vienna.
...
Assume monthly Search budget = **B**. Adjust absolute numbers to account size.

| Campaign group | Share of B | Rationale |
|----------------|------------|-----------|
| TO Israel + Repatriation + Emergency | 40% | Core demand |
| ICU + Private Air Ambulance | 20% | High value |
| FROM Israel | 15% | Distinct intent |
| Escort + Commercial Escort + Stretcher | 15% | Volume / mid-ticket |
| Bed-to-bed + Intl Transfer | 5% | Support themes |
