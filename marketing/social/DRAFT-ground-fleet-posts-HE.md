...
**תמונה:** `1704771607740506` (אמבולנס בשקיעה)
...
## מה צריך ממך לאישור
1. לאשר / לתקן את נוסחי הפוסטים  
2. לסמן תמונת **מיטה חשמלית** בדף הפייסבוק  
3. להגיד אם לפרסם עכשיו: רק פוסט 1+3+4, או את כולם  
אחרי אישור — מפרסם ל-FB+IG עם התמונות מהדף בלבד.
