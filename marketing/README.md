...
Complete Google Ads, SEO, landing-page, and social content system optimized for **private emergency leads**: phone calls, WhatsApp, and website form submissions for **Air Ambulance TO Israel** and **Air Ambulance FROM Israel**.
...
| [google-ads/01-campaign-structure.md](google-ads/01-campaign-structure.md) | Campaigns, ad groups, geo, budgets, bidding |
...
| File | Purpose |
|------|---------|
| [seo/landing-page-recommendations.md](seo/landing-page-recommendations.md) | LP CRO for emergency private leads |
| [seo/seo-roadmap.md](seo/seo-roadmap.md) | Keyword clusters, pages, 90-day SEO plan |
